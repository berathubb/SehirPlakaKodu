package com.beratates.sehirplakakodu

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.view.LayoutInflater
import com.beratates.sehirplakakodu.databinding.ActivityMainBinding
        ...
        binding.button.setOnClickListener{
            if (binding.editTextNumber.text.isNotEmpty()){
                ...
                when(plakakodu){
                    ...
                    31->binding.textView.text = "Isparta"
                    32->binding.textView.text = "İçel"
                ...
                binding.textView.text = "Şehir Plaka Kodunu Girin"
            }
